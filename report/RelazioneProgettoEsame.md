...
Dal punto di vista dell’identità visiva, il progetto è stato sviluppato prendendo
ispirazione dalle moderne piattaforme di pubblicazione digitale, in particolare
dal modello editoriale adottato da Substack, caratterizzato da un’esperienza di
lettura focalizzata sul contenuto, una struttura semplice e una forte attenzione
alla leggibilità degli articoli.

L’obiettivo non è stato quello di replicare direttamente l’interfaccia di Substack,
ma di adottarne alcuni principi editoriali, mantenendo i vantaggi di un sito web
strutturato e facilmente aggiornabile. Non è stato utilizzato un foglio di stile
specifico per riprodurre il design della piattaforma.

Le principali scelte stilistiche adottate sono:

- attenzione alla leggibilità del testo attraverso una tipografia più adatta alla
  lettura prolungata;
- utilizzo di una gerarchia visiva chiara tra titoli, sezioni e corpo dell’articolo;
- mantenimento di una struttura grafica semplice, con elementi visivi minimali
  per ridurre le distrazioni;
- organizzazione dei contenuti in articoli indipendenti, facilitando la consultazione
  e il successivo aggiornamento.

Questa scelta mira a combinare l’affidabilità tipica della comunicazione scientifica
con un’esperienza utente ispirata ai moderni strumenti di pubblicazione digitale,
rendendo i contenuti più accessibili anche a lettori non specialisti.
...
Lo stile visivo del sito è stato definito tramite il tema **MkDocs Material**, configurato
attraverso il file `mkdocs.yml`. Sono state effettuate alcune personalizzazioni
del tema, tra cui la scelta della palette cromatica, dei font e delle funzionalità
di navigazione, con l'obiettivo di ottenere un'interfaccia più vicina a una
pubblicazione editoriale digitale rispetto al tema documentale predefinito.
La progettazione grafica si è ispirata al modello delle newsletter digitali,
come Substack, privilegiando semplicità, leggibilità dei contenuti e una chiara
gerarchia visiva tra titoli, sezioni e testo principale.
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{./logo/mermaid3.png}
...
Per la presentazione dei contenuti è stato adottato il tema **Material for MkDocs**,
configurato attraverso il file `mkdocs.yml`. La scelta di questo tema permette di
ottenere una struttura grafica ordinata e coerente, mantenendo una separazione
tra i contenuti editoriali e gli aspetti di presentazione.
L’organizzazione visiva del sito è stata sviluppata prendendo ispirazione dalle
piattaforme editoriali digitali moderne, in particolare dal modello di Substack,
caratterizzato da un’esperienza di lettura semplice e focalizzata sul contenuto.
Non è stata realizzata una replica grafica della piattaforma, ma sono stati
adottati principi simili, come una struttura chiara degli articoli, una gerarchia
visiva definita e un’interfaccia priva di elementi superflui.
Questa scelta contribuisce al raggiungimento degli scenari d’uso perché permette
agli utenti di concentrarsi sul contenuto scientifico, rendendo gli articoli più
facili da consultare e aggiornare nel tempo.
...
| Miglioramento della qualità dei documenti | La separazione tra contenuto e presentazione permette di concentrarsi maggiormente sulla qualità editoriale, mentre il tema Material for MkDocs garantisce una presentazione coerente. |
...
| Stile grafico | Coerenza gestita manualmente. | Stile centralizzato con MkDocs. |
