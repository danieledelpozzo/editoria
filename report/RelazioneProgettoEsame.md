...
|---|---|
| `mkdocs.yml` | Configurazione del sito: tema grafico, foglio di stile personalizzato, struttura di navigazione |
| `docs/index.md` | Homepage del progetto editoriale |
| `docs/article1.md` – `article4.md` | I quattro articoli editoriali, ciascuno basato su un paper scientifico open access differente |
| `docs/substack.css` | Foglio di stile personalizzato per l'aspetto grafico del sito |
| `.github/workflows/mkdocs.yml` | Configurazione della pipeline di pubblicazione automatica (GitHub Actions) |
| `README.md` | Introduzione alla repository |
| `site/` | Cartella generata automaticamente da mkdocs build |
